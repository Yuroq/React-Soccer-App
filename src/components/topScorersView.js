...
if(!hideScorers)  { return <div>
      ...
      <div className={classes.player_standings_info}>
            ...
            <h3 className={classes.player_standings_info_nationality}>Nationality</h3>
      ...
      {topScorers.slice(0,10).map((player) => (
       ...
       <div className={classes.goal_standings}>
               ...
               <h2>{player.player.name}</h2>
                <img src={player.statistics[0].team.logo} className={classes.Goal_standings_team_logo}/>
               <p className={classes.goal_standings_team}>{player.statistics[0].team.name}</p>
               {/* <img src={player.statistics[0].league.flag} className={classes.Goal_standings_country_logo}/> */}
               <p className={classes.goal_standings_country}>{player.player.nationality}</p>
               <p className={classes.goal_standings_position}>{player.statistics[0].games.position}</p>
               <p className={classes.goal_standings_goals}>{player.statistics[0].goals.total}</p> 
