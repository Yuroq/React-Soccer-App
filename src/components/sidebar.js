...
<span className='saved-games-icon'>{!showSavedPage && <AiIcons.AiOutlineHeart/>}{showSavedPage && <AiIcons.AiFillHeart/>}</span>
...
<div style={{position:'absolute',top: "400px"}}>
      <Accordion >
        <AccordionSummary
          ...
          id="panel1a-header"
        >
          <Typography ><PiIcons.PiSoccerBallFill/><strong>Leagues</strong></Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
<div>
                <button onClick={setLeaguePrem} className='Prem-Button'>Premier League</button>
       
                <br></br>
                <button onClick={setLeagueBundesliga} className='Bundesliga-Button'>Bundesliga</button>
                <br></br>
          
                <button onClick={setLeagueLiga} className='Liga-Button'>La Liga</button>
           
                <br></br>
                <button onClick={setLeagueMls} className='Mls-Button'>MLS</button>
              </div>
          </Typography>
        </AccordionDetails>
      </Accordion>
     ...
     {showSearch && <SearchView teamName={teamLookup}/>}
      {!showSearch && <HomeView leagueChosen={league} savedGameHandler={game => savedGameArray.push(game)}showSavedGame={showSavedPage}/>}
