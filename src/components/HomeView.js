...
<div className={classes.container}>
 ...
 {league && <TopScorers league={league} hideTopScorers={showSavedPage}/>} 
   </div>
   </div>
   </div>
      <div className={classes.nav}>
        ...
        <span>
          <button onClick={showUpcomingHandler} className={classes.Upcoming_Button}>Upcoming fixtures</button>
        </span>
        <span>
          <button onClick={showRecentHandler} className={classes.Recent_Button}>Recent fixtures</button>
        </span>
      </div>
...
{currentlyShowing == 'Standings' && <Standings leagues={league} isShowing={currentlyShowing} />}
{currentlyShowing == 'Recent' && <RecentFixtures leagues={league} isShowing={currentlyShowing} />}
 <UpcomingFixtures leagues={league} isShowing={currentlyShowing} showSavedGame={showSavedPage}/>
