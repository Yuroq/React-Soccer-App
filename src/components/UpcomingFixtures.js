...
useEffect(() => {
  {showingUpcoming == 'Upcoming' &&  fetch(
...
<div>
              ...
              <div className={classes.league_standings_fixtures} key={index}>
                  ...
                  <img src={Upcoming.teams.home.logo} className={classes.league_standings_fixtures_home_image}/>
                         <h3 className={classes.Upcoming_fixtures_home}>{Upcoming.teams.home.name}</h3>
                         <div className={classes.square}><p>{moment(Upcoming.fixture.date).format('MMM DD,YYYY')}</p></div>
                         <img src={Upcoming.teams.away.logo} className={classes.fixtures_away_logo}/>
                         <h3 className={classes.fixtures_away}>{Upcoming.teams.away.name}</h3>
                         <MdOutlineStadium className={classes.upcoming_fixtures_venue_icon}/>
              <h5 className={classes.upcoming_fixtures_venue_name}>{Upcoming.fixture.venue.name},  {Upcoming.fixture.venue.city}</h5>
